...
import { ArrowUpRight, Sparkles, Mail, MapPin, ArrowUp } from "lucide-react";
...
.footer-glass-pill:hover {
  ...
  box-shadow: 
      0 20px 40px -10px rgba(78, 168, 64, 0.3), 
...
.footer-text-glow {
  ...
  background-clip: text;
  filter: drop-shadow(0px 0px 30px rgba(78, 168, 64, 0.35));
  font-family: 'Outfit', sans-serif;
}
`;
