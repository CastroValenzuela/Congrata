...
import { Users2, Sparkles, Award } from 'lucide-react';
...
export default function TeamSection() {
  return (
    <section id="team" className="py-24 relative overflow-hidden bg-white/[0.01]">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-cyan-500/10 rounded-full blur-3xl pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <p className="text-slate-400 max-w-2xl text-base sm:text-lg leading-relaxed">
            An interdisciplinary council of academic researchers, University of California partners, and social innovators guiding scholars to international excellence.
          </p>
        </div>

        {/* Team Showcase Card Container */}
        <motion.div
