      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <motion.div
            ...
            className="lg:col-span-7 bg-white rounded-3xl border border-emerald-900/10 shadow-xl shadow-emerald-950/5 relative overflow-hidden group min-h-[440px] hover:border-[#4EA840] transition-all"
          >
          ...
          <motion.div
            ...
            className="lg:col-span-5 bg-gradient-to-br from-amber-50/80 via-white to-amber-50/40 rounded-3xl border border-amber-300/80 shadow-xl shadow-amber-950/5 relative overflow-hidden group min-h-[440px]"
          >
            <SpotlightCard className="p-8 sm:p-10 flex flex-col justify-between h-full">
              <div>
