...
export default function FoundersStory() {
  return (
    <section id="founder" className="pt-24 pb-36 sm:pb-44 relative overflow-hidden bg-[#071917] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <h2 className="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight mb-4 font-heading">
            Founder’s <span className="text-[#4EA840]">Inspiration</span>
          </h2>
          <p className="text-emerald-300/80 text-lg sm:text-xl font-light italic max-w-2xl text-center">
        ...
        <motion.div
          ...
          className="bg-[#0C2421]/90 backdrop-blur-xl rounded-3xl p-8 sm:p-14 border border-emerald-500/20 relative overflow-hidden shadow-2xl"
        >
          {/* Subtle Watermark Quote */}
          <Quote className="absolute -bottom-10 -right-10 w-72 h-72 text-emerald-500/[0.04] pointer-events-none" />
          ...
          <div className="max-w-4xl mx-auto space-y-8 text-slate-300 leading-relaxed text-base sm:text-lg">
            ...
            <div className="my-10 p-8 sm:p-10 rounded-3xl bg-[#061614] border border-emerald-500/30 relative shadow-inner">
              <div className="text-xs font-mono font-bold uppercase tracking-widest text-emerald-400 mb-3 flex items-center gap-2">
                <Sparkles className="w-3.5 h-3.5 text-[#4EA840]" />
                <span>Foundational Truth</span>
              </div>
              <ScrollWordReveal className="text-xl sm:text-2xl lg:text-3xl font-bold font-heading leading-snug text-white">
            ...
            {/* Conclusion & Mandate */}
            <div className="pt-8 border-t border-emerald-950/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div>
                ...
                <p className="text-[#4EA840] font-bold text-lg mt-2">
                  That answer became CONGRATA.
                </p>
              </div>

              <div className="flex-shrink-0 flex items-center gap-3 bg-emerald-950/80 px-5 py-3.5 rounded-2xl border border-emerald-500/30 shadow-sm">
                <div className="w-10 h-10 rounded-xl bg-emerald-900/60 flex items-center justify-center text-[#4EA840]">
