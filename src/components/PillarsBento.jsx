...
import { PlaneTakeoff, Award, Lightbulb, ArrowUpRight, ShieldCheck, Rocket, Sparkles, Globe2, BookOpen } from 'lucide-react';

export default function PillarsBento() {
  return (
    <section id="programs" className="py-24 relative overflow-hidden bg-white/[0.01]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* Pillar 1: Large Featured Card with Integrated Photographic Imagery (Span 7) */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="lg:col-span-7 glass-panel glass-panel-hover rounded-3xl p-8 sm:p-10 relative overflow-hidden flex flex-col justify-between group min-h-[460px]"
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-300 text-base sm:text-lg leading-relaxed mb-6">
                Enabling young researchers to step outside institutional comfort zones. Through structured international mobility programs, scholars immerse themselves in world-class research environments, collaborating with foreign institutions and broadening their academic horizons.
              </p>
            </div>
            ...
            <div className="relative z-10 pt-6 border-t border-white/10 flex flex-wrap items-center gap-3">
              ...
              <span className="text-xs px-3.5 py-1.5 rounded-xl bg-cyan-500/10 text-cyan-300 border border-cyan-500/20 font-medium">
                🏛️ UC Partnership Heritage
              </span>
            </div>
          </motion.div>

          {/* Right Column (Span 5): 2 Stacked Cards with Thematic Photos */}
          <div className="lg:col-span-5 flex flex-col gap-6">
            {/* Pillar 2: Rewarding Stewardship Development */}
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              transition={{ duration: 0.6, delay: 0.1 }}
              className="glass-panel glass-panel-hover rounded-3xl p-8 relative overflow-hidden flex flex-col justify-between group flex-1 min-h-[220px]"
            >
              {/* Background Photo */}
              <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
                <img
                  src="https://images.unsplash.com/photo-1532094349884-543bc11b234d?q=80&w=1200&auto=format&fit=crop"
                  alt="Scientific Stewardship"
                  className="w-full h-full object-cover object-center opacity-15 group-hover:opacity-25 group-hover:scale-105 transition-all duration-700"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#090D16] via-[#090D16]/85 to-[#090D16]/40" />
              </div>
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-300 text-sm leading-relaxed mb-4">
                  Fostering collaborative leadership, scientific ethics, and a duty to mentor incoming generations. We prepare researchers to become conscientious stewards of their disciplines and communities.
                </p>
              </div>
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-slate-300 text-sm leading-relaxed mb-4">
                  Transforming scientific inquiry into practical, scalable solutions. Scholars develop the entrepreneurial mindset required to generate measurable economic, cultural, and community prosperity.
                </p>
              </div>
